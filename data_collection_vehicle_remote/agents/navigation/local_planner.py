...
import carla
from data_collection_vehicle_remote.agents.navigation.controller import VehiclePIDController
from data_collection_vehicle_remote.agents.tools.misc import draw_waypoints
...
class LocalPlanner(object):
    ...
    def done(self):
        print((len(self._waypoints_queue) == 0 and len(self._waypoint_buffer) == 0))
