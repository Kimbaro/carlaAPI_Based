...
import data_collection_vehicle_remote.util.VehicleRouteManager
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    # 긴급제어 =======================
                    if self._autopilot_remote:
                        print("emergency remote on")
                        routeManager.ui_dcv_remote_speed(mode=self._autopilot_remote, speed=0)
                        self._autopilot_remote = False
                    else:
                        print("emergency remote off")
                        routeManager.ui_dcv_remote_speed(mode=self._autopilot_remote)
                        self._autopilot_remote = True
                ...
                if event.key == k.K_LEFT:
                    ...
                    # target_actor_attr = TargetActorAttr(self.carla_world)
                    #
